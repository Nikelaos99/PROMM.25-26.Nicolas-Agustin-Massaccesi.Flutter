...
export "ejercicio4_iconos.dart"; // Pantalla o widget relacionado con íconos personalizados
export "ejercicio5_fotos_en_columna2.dart"; // Muestra imágenes organizadas en una columna
export 'ejercicio6_textos.dart'; // Pantalla con textos estilizados
export 'ejercicio7_imagenes_repetidas.dart'; // Pantalla con la misma imagen cargada de distintas formas
export 'ejercicio8_piramide.dart'; // Pantalla con estructura tipo pirámide
export "ejercicio9_reto.dart"; // Pantalla de desafío o actividad interactiva
export "ejercicio10_contador.dart"; // Pantalla con contador
